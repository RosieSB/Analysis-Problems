...
3. For $f_2:A\to \mathbb{R}$ as in part (ii) of the question [q:44](#q:44), investigate each of
...
12. Return to Problem [q:44](#q:44). Consider each function there, defined on the largest subset $A$ of $\mathbb{R}$
